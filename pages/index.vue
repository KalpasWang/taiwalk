...
<template>
  <main>
    <section ref="el" class="home__container">
      <div>
        <h1 class="home__title"
          >探索
          <span class="home__highlight">台灣之美</span>
        </h1>
        <h2 class="home__title">讓我們更親近這片土地</h2>
      ...
      <div>
        <ElForm :model="form">
          ...
          <ElButton type="primary" size="large" class="home__searchBtn"
...
.home__select:deep() .el-select__wrapper {
  min-height: 50px;
  line-height: 1.75;
  font-size: 1rem;
}
.home__input:deep() .el-input__wrapper {
  padding: 6px 15px;
  line-height: 1.75;
  font-size: 1rem;
}
